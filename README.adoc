...
image:https://sonarcloud.io/api/project_badges/measure?project=parolisoft_dbquerywatch&metric=coverage[Coverage, link="https://sonarcloud.io/summary/new_code?id=parolisoft_dbquerywatch"]
